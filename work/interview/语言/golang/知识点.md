...
管理内存：手动和自动两种方式。C、C++ 以及 Rust 等编程语言使用手动的方式管理内存，工程师需要主动申请或者释放内存；而 Python、Ruby、Java 和 Go 等语言使用自动的内存管理系统
...
- https://studygolang.com/articles/25096?fr=sidebar
- https://mp.weixin.qq.com/s/yD0JX85aSSC-O8ynanRvvw
